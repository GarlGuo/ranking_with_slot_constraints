...
parser = argparse.ArgumentParser(description="ranking with tmc2007 dataset")
parser.add_argument(
    "--slots_per_label",
    type=int,
    default=30
...
graph_dir = f'graph{os.sep}multilabel-graph{os.sep}tmc2007'

dataset = TMC2007_Dataset(slots_per_label=args.slots_per_label)
...
fig.suptitle(f"TMC2007 Dataset ({args.slots_per_label} Slots Per Label)", fontsize=14)
fig.tight_layout()
