...
PR_and_ranker  = RelevanceRanker(dataset.test_relevance_and)
PR_or_ranker   = RelevanceRanker(dataset.test_relevance_or)
random_ranker  = RandomRanker(dataset.test_R_samples)

match_ranking  = match_ranker.rank_lazy(k=3000)
TB_ranking     = TR_ranker.rank()
